        ...
        <div className="flex flex-col gap-y-12">
          {paslonTiga.map((paslon, i) => (
            <div key={i} className="flex flex-col">
                ...
                <AuroraBackground className="relative w-full h-full bg-slate-700">
                  ...
                  >
                    ...
                    <CardContent className="flex justify-center py-0">
                      <Image
                        src={`${
                          i === 0 ? "/img/wilbert.png" : "/img/jacob.png"
                        }`}
                        alt={paslon.nama}
                        width={400}
                        height={400}
                ...
                <div className="flex">
                  <Avatar className="w-16 h-16">
                    <AvatarImage
                      ...
                      className="object-cover bg-cyan-600"
                    />
              ...
              <button className="px-8 py-2 mx-4 mt-4 rounded-md bg-teal-500 text-white font-bold transition duration-200 hover:bg-white hover:text-black border-2 border-transparent hover:border-teal-500">
